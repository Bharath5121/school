...
import type { ContentStats, DashboardSummary } from '@/features/dashboard/types';
import {
...
export default function AdminDashboard() {
  ...
  const [userStats, setUserStats] = useState<DashboardSummary | null>(null);
  const [loading, setLoading] = useState(true);

  useEffect(() => {
    Promise.all([
      dashboardApi.getContentStats().catch(() => null),
