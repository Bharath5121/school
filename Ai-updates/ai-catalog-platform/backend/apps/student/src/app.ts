...
import myStuffRoutes from './features/my-stuff/routes/my-stuff.routes';
import buddyRoutes from './features/ask-buddy/routes/buddy.routes';
import onboardingRoutes from './features/onboarding-flow/routes/onboarding.routes';
...
app.use('/api/my-stuff', myStuffRoutes);
